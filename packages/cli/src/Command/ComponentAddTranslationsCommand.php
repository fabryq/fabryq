...
/**
 * Console command that adds translation scaffolding to a component.
 *
...
/**
 * Adds Resources/translations to a component.
 */
#[AsCommand(
    name: 'fabryq:component:add:translations',
    description: 'Add translations scaffolding to a component.'
)]
final class ComponentAddTranslationsCommand extends AbstractFabryqCommand
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setDescription('Add translations scaffolding to a component.');
        parent::configure();
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $targetDir = $component['path'] . '/Resources/translations';
        $keepPath = $targetDir . '/.keep';

        if ($dryRun) {
            $io->title('Dry-run: fabryq:component:add:translations');
        ...
        if ($this->filesystem->exists($targetDir)) {
            $io->success('Translations directory already exists.');
            return CliExitCode::SUCCESS;
        }
        ...
        $io->success('Translations scaffolding created.');
